...
class _AdminDataExportScreenState extends State<AdminDataExportScreen> {
  ...
  void _onGradeChanged(int? gradeId) {
    setState(() {
      ...
      _filteredClasses = gradeId == null
          ? _allClasses
          : _allClasses.where((c) => c.gradeId == gradeId).toList();
    });
  }
  ...
  Future<void> _doExport(String type) async {
    ...
    try {
      ...
      if (type == 'course_requests') {
        final bytes = await AdminService.exportCourseRequests();
        await _saveAndOpen(bytes, '审批记录_$today.xlsx');
      } else if (type == 'students') {
        final bytes = await AdminService.exportStudents(
          ...
          : ListView(
              ...
              children: [
                _ExportCard(
                  ...
                  title: '审批记录',
                  subtitle: '导出全校所有选课审批记录（编号、申请人、课程、状态、审批人、备注）',
                  exporting: _exporting && _exportingType == 'course_requests',
                  onExport: _exporting ? null : () => _doExport('course_requests'),
                ),
                      ...
                      children: [
                          ...
                          const Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '导出学生名单（学号、姓名、性别、年级、班级、选修班、学籍状态）',
                                  style: TextStyle(
                        ...
                        DropdownButtonFormField<int?>(
                          ...
                          items: [
                            const DropdownMenuItem(
                                value: null, child: Text('全部年级')),
                            ..._grades.map((g) => DropdownMenuItem(
                        ...
                        DropdownButtonFormField<int?>(
                          ...
                          items: [
                            ...
                            ..._filteredClasses.map((c) => DropdownMenuItem(
